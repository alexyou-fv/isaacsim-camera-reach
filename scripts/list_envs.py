...
All the environments are registered in the `reach_with_cameras` extension. They start
...
import reach_with_cameras.tasks  # noqa: F401


def main():
    """Print all environments registered in `reach_with_cameras` extension."""
